...
namespace PipeLib
{
    public class PipeStringServer : PipeClientServerBase
    {
        public PipeStringServer(string pipeName)
            : base(pipeName)
        {
        }

        protected override BasicPipe CreatePipe() => new ServerPipe(PipeName, p => p.StartByteReader());
